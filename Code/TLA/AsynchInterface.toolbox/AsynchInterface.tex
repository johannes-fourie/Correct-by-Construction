...
\@x{ {\EXTENDS} Naturals}%
\@x{ {\CONSTANTS} Data}%
\@x{ {\VARIABLES} value ,\, ready ,\, acknowledge}%
\@x{ TypeInvariant \.{\defeq} \.{\land} value\@s{0.77} \.{\in} Data}%
\@x{\@s{80.80} \.{\land} ready \.{\in} \{ 0 ,\, 1 \}}%
\@x{\@s{80.80} \.{\land} acknowledge \.{\in} \{ 0 ,\, 1 \}}%
\@x{}\midbar\@xx{}%
\@x{ Init\@s{5.17} \.{\defeq} \.{\land} value\@s{0.77} \.{\in} Data}%
\@x{\@s{40.87} \.{\land} ready \.{\in} \{ 0 ,\, 1 \}}%
\@x{\@s{40.87} \.{\land} acknowledge \.{=} ready}%
\@pvspace{8.0pt}%
\@x{ Send \.{\defeq} \.{\land} ready \.{=} acknowledge}%
\@x{\@s{40.87} \.{\land} value \.{'}\@s{0.77} \.{\in} Data}%
\@x{\@s{40.87} \.{\land} ready \.{'} \.{=} 1 \.{-} ready}%
\@x{\@s{40.87} \.{\land} {\UNCHANGED} acknowledge}%
\@pvspace{8.0pt}%
\@x{ Receive \.{\defeq} \.{\land} ready \.{\neq} acknowledge}%
\@x{\@s{51.46} \.{\land} acknowledge \.{'} \.{=} 1 \.{-} acknowledge}%
\@x{\@s{51.46} \.{\land} {\UNCHANGED} {\langle} value ,\, ready {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Send \.{\lor} Receive}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle}
 value ,\, ready ,\, acknowledge {\rangle}}}%
\@x{}\midbar\@xx{}%
